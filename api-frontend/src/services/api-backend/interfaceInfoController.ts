...
/** getInterfaceInfoList GET /api/interfaceInfo/list */
...
/** getInterfaceInfoByPage GET /api/interfaceInfo/list/page */
export async function getInterfaceInfoByPageUsingGET(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getInterfaceInfoByPageUsingGETParams,
  options?: { [key: string]: any },
) {
